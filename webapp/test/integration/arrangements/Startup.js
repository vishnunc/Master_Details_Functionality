sap.ui.define([
	"sap/ui/test/Opa5",
	"com/masterdetail/Master-Detail/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("com.masterdetail.Master-Detail.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.masterdetail.Master-Detail",
					async: true
				},
				hash: oOptions.hash,
